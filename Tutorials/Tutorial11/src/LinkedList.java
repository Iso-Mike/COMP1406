public class LinkedList {
    ...
    private boolean isInIncreasingOrder(Item currHead) {
        if(currHead == null || currHead.next == null) { return true; }

        if(currHead.data >= currHead.next.data) { return false; }

        return isInIncreasingOrder(currHead.next);
    }
}
