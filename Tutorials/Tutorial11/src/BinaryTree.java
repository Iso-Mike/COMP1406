...
public class BinaryTree {
    ...
    public boolean isTheSameAs(BinaryTree t) {
        if(t.data == data && t.leftChild == null && t.rightChild == null && leftChild == null && rightChild == null) { return true; }

        if(t.data != data) { return false; }

        return leftChild.isTheSameAs(t.leftChild) && rightChild.isTheSameAs(t.rightChild);
    }
    ...
    public boolean contains(String d) {
        if(data != null) {
            ...
            if(leftChild.data == null && rightChild.data == null) { return false; }
