...
public class Spotify {
    ...
    public void search(String search){
        ...
        for(int i = 0 ; i < songDatabase.length; i++){
            //if it contains the same characters as 'search'
            //if the song at this index 'matches' search
            if(songDatabase[i] != null && songDatabase[i].matchesSearch(search)){
        ...
        for(int i = 0 ; i < playlists.length; i++){
            //if it contains the same characters as 'search'
            //if the song at this index 'matches' search
            if(playlists[i] != null && playlists[i].matchesSearch(search)){
